...
function openAddDataModal() {
  ...
  if (phieuXuatInput && window.XgSapLookup && window.XgSapLookup.initSapDocumentAutocomplete) {
    ...
    window.XgSapLookup.initSapDocumentAutocomplete(phieuXuatInput, formEl, 'xg-xuat');
  }
...
function openEditDataModal() {
  ...
  if (phieuXuatEditInput && window.XgSapLookup && window.XgSapLookup.initSapDocumentAutocomplete) {
    ...
    window.XgSapLookup.initSapDocumentAutocomplete(phieuXuatEditInput, editFormEl, 'xg-xuat');
  }
