...
async function populateExportReceiptFromSap(headerInfo, itemsGrouped) {
  ...
  if (headerInfo.maCongTrinh) {
    const maCtInp = form.querySelector('[name="col_11"]') || form.querySelector('[name="col_10"]') || form.querySelector('[name="add_ext_11"]');
    if (maCtInp) {
  ...
  if (headerInfo.tenCongTrinh) {
    const tenCtInp = form.querySelector('[name="col_12"]') || form.querySelector('[name="col_11"]') || form.querySelector('[name="add_ext_12"]');
    if (tenCtInp) {
