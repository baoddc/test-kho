(function () {
  ...
  const DOWNLOAD_PC_EXE_URL = window.APP_DOWNLOAD_LINKS.pcExe || '/downloads/DDC-Kho-Setup-1.0.5.exe';
  const DOWNLOAD_PC_RAR_URL = window.APP_DOWNLOAD_LINKS.pcRar || '/downloads/DDC-Kho-Setup-1.0.5.rar';
