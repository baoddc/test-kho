...
function updateSelectedRows() {
  ...
  if (selectedRowIndexes.length > 0) {
    ...
    btnEdit.disabled = true; btnDelete.disabled = true; btnDelete.textContent = 'Xóa dữ liệu';
  }
...
function renderInventoryTable(data, searchVal = '') {
  ...
  // Xác định cột cần hiển thị trong inventory table
  // Bảng xg-ton cần có: Mã vật tư, Tên vật tư, Batch, Cuộn ID, Tồn cuối (Kg)
