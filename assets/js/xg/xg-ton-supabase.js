/* =============================================================================
   XG-TON - SUPABASE VERSION
   Quản lý dữ liệu tồn xà gồ từ Supabase
   Tên bảng: xg-ton
   Cột: id, Ngày nhập, Thời gian lưu kho, Vị trí, Mã vật tư, Tên vật tư,
         Batch, Cuộn ID, Số lượng (Kg), Mã công trình, Tên công trình, Ghi chú
================================================================================ */

// Tên bảng Supabase
const TABLE_NAME = 'xg-ton';
